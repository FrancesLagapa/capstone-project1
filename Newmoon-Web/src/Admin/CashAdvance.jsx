    ...
    <div className="p-6 bg-gradient-to-br from-[#E3F2FD]/30 via-white to-[#FFEBEE]/30 min-h-screen">
        ...
        <div className="px-8 py-6 relative">
          ...
          <div className="flex items-center justify-between relative z-10">
            <div>
              <h1 className="text-2xl font-bold text-white mb-1">
                <FontAwesomeIcon icon={faPesoSign} className="mr-2" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4 relative z-10">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3">
              ...
              <p className="text-white font-bold text-xl">{fmtCurrency(stats.totalAmount)}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            <h2 className="text-xl font-semibold text-[#1A237E]">
              <FontAwesomeIcon icon={faPesoSign} className="mr-2 text-[#E53935]" />
      ...
      <Card className="rounded-xl border border-[#E3F2FD] shadow-sm">
        <Table
          ...
          locale={{ emptyText: <div className="py-8 text-center"><FontAwesomeIcon icon={faPesoSign} className="text-4xl text-gray-300 mb-2" /><p className="text-gray-500">No cash advance requests found</p><p className="text-gray-400 text-sm">Try adjusting your filter</p></div> }}
        />
      </Card>
      ...
      <Modal
        title={
          <span>
            ...
            <span className="text-[#1A237E] font-bold">Approve Cash Advance</span>
          </span>
        }
      ...
      >
        {selected && (
          <div className="mb-4 p-4 rounded-xl bg-[#E3F2FD]">
            ...
            <div className="text-lg font-bold text-[#3f8600]">{fmtCurrency(selected.amount)}</div>
      ...
      <Modal
        title={
          <span>
            ...
            <span className="text-[#1A237E] font-bold">Reject Cash Advance</span>
          </span>
        }
      ...
      >
        {selected && (
          <div className="mb-4 p-4 rounded-xl bg-[#FFEBEE]">
            <div className="font-semibold text-[#1A237E]">{selected.user?.firstname} {selected.user?.lastname}</div>
            <div className="text-lg font-bold text-[#E53935]">{fmtCurrency(selected.amount)}</div>
            {selected.reason && <div className="text-gray-600 text-sm mt-1">Reason: {selected.reason}</div>}
          </div>
        )}
